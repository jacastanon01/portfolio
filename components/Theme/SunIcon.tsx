  ...
  return (
    ...
    >
      <path
        ...
        className='fill-primary transition-all duration-500 group-hover:hover:fill-primary-dark'
      />
      <path
        d='M15 10C15 12.7615 12.7615 15 10 15C7.23853 15 5 12.7615 5 10C5 7.23853 7.23853 5 10 5C12.7615 5 15 7.23853 15 10Z'
        className='fill-primary transition-all group-hover:hover:fill-primary-dark'
      />
      <path
